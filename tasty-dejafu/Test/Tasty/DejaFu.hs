...
-- Stability   : stable
-- Portability : FlexibleContexts, FlexibleInstances, GADTs
--
...
module Test.Tasty.DejaFu
  ...
  -- | This is supported by an 'IsTest' instance for 'DejaFu IO'. This
  -- instance treis all executions, reporting as failures the cases
  -- which return a 'Just' string.
  --
  -- @instance IsTest (DejaFu IO (Maybe String))@
...
-- | @since unreleased
instance IsTest (Conc.DejaFu IO (Maybe String)) where
