...
data T where
  T  :: Show a => String -> DejaFu IO a -> Predicate a -> T
  BT :: Show a => String -> DejaFu IO a -> Predicate a -> Bounds -> T

testGroup :: IsTest t => String -> t -> TF.Test
testGroup name = TF.testGroup name . toTestList

djfu :: Show a => String -> Predicate a -> DejaFu IO a -> TF.Test
djfu name p c = head . toTestList $ testDejafu c name p

djfuT :: Show a => String -> Predicate a -> DejaFu IO a -> [TF.Test]
